...
const URL_KEY = "lambda.tiled_api_url";
const KEY_KEY = "lambda.tiled_api_key";
export const TILED_SERVER_CHANGED = "lambda-tiled-server-changed";

export const ENV_TILED_API_URL =
  import.meta.env.VITE_TILED_API_URL ?? "http://127.0.0.1:8000/api/v1";
